        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-[9999]">
            <div class="bg-gray-100 rounded-2xl p-8 space-y-6 max-w-md w-full relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Opción Mascota -->
                    <a href="/registro-mascota" class="font-semibold border border-gray-300 bg-gray-100 hover:bg-gray-200 text-gray-800 hover:border-gray-400 p-4 rounded-lg transition flex items-center space-x-3">
