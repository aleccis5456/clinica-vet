   ...
   <!-- Contenedor principal -->
    <div class="container mx-auto p-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-cover bg-center rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 relative"
                ...
                <div class="relative z-10 p-4 md:p-6 hover:backdrop-blur-sm">
            ...
            <div class="bg-cover bg-center rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 relative"
                ...
                <div class="relative z-10 p-4 md:p-6">
                    ...
                    <a href="#"
                        class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-300 group">
                        Acceder
                        <svg class="w-5 h-5 ml-2 transition-transform duration-300 group-hover:translate-x-1"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
    ...
    <div>
        ...
        <div class="fixed inset-0  flex items-center justify-center p-4 z-[9999]">
            <div class="bg-black/50 backdrop-blur-lg border border-gray-500 rounded-2xl p-8 space-y-6 max-w-md w-full relative">
                <!-- Botón de cierre -->
                <button wire:click="cerrarModal" class=" cursor-pointer absolute top-3 right-3 text-gray-100 hover:text-gray-900">
                ...
                <h3 class="text-2xl font-bold text-center text-white">¿Qué deseas registrar?</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Opción Dueño -->
                    <a href="{{ route('add.dueno') }}" class="block bg-blue-500 hover:bg-blue-600 text-white p-4 rounded-lg transition flex items-center space-x-3">
                    ...
                    <!-- Opción Mascota -->
                    <a href="/registro-mascota" class="block bg-green-500 hover:bg-green-600 text-white p-4 rounded-lg transition flex items-center space-x-3">
