<div class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-[9999]">
    <div class="bg-white rounded-2xl p-8 space-y-6 max-w-md w-full relative">
        <!-- Botón de cierre -->
        <button wire:click="closeModalEdit" class=" cursor-pointer absolute top-3 right-3 text-gray-800 hover:text-gray-900">
        ...
        <div class="grid grid-cols-1">
            <form wire:submit='crearDueno' class=" p-6 max-w-md mx-auto">                
