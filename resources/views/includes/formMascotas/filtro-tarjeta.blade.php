<div id="confirmarModal" tabindex="-1"
    ...
    <div class="relative p-4 w-lg md:w-md ">
        ...
        <div class="h-auto w-full bg-white p-10 rounded-lg">
            <form wire:submit.prevent="filtrarVacunas" class="w-full">
                ...
                <div class="p-4">
                    <div class="mb-4">
                        ...
                        <input wire:model="desde" type="date" id="fecha_desde" name="fecha_desde" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                    </div>
                    <div class="mb-4">
                        <label for="fecha_hasta" class="block text-sm font-medium text-gray-700">Hasta</label>
                        <input wire:model='hasta' type="date" id="fecha_hasta" name="fecha_hasta" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                    </div>
                    <div class="w-full justify-center flex">
                        <button type="submit" class="px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 cursor-pointer">Filtrar</button>
                    </div>
                </div>
            </form>
            
            <div>
                <p class="cursor-pointer bg-red-400 font-semibold  text-white py-2 px-4 rounded-md mt-4">Exportar tarjeta a PDF</p>
            </div>
        </div>
    </div>
</div>
