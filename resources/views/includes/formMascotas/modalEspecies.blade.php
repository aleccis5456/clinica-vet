<div id="" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md">
        ...
        <form wire:submit='crearEspecie'
            class="bg-white border border-gray-100 p-8 max-w-md mx-auto shadow-lg  {{ $tableEspecies == true ? 'rounded-t-lg' : 'rounded-lg' }} max-h-[620px] outline-none overflow-x-hidden overflow-y-auto">
            <p class="text-2xl font-semibold text-center text-gray-800 mb-6">Agregar Especie</p>
