        ...
        <div class="max-h-[300px] overflow-y-auto rounded-b-lg">
            <table class="min-w-full bg-white rounded-b-lg shadow-md ">
                ...
                <tbody class="text-gray-800">
                    ...
                    <tr wire:key='{{ $tipoConsulta->id }}' class="border-t border-gray-200 hover:bg-gray-100 transition duration-300">
                        <td class="py-3 px-4">{{ $tipoConsulta->nombre }}</td>
                        <td class="py-3 px-4 font-semibold">
                            <button type="button"
                                class="cursor-pointer ml-2 text-gray-800 bg-gray-300 hover:bg-gray-500 focus:ring-2 focus:ring-red-300 rounded-md px-3 py-1">
                                  Editar
                            </button>
                            <button  type="button"
